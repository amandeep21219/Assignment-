...
import com.example.PdfReader.Service.PdfServiceImpl;
...
public class PdfController {
    ...
    public ResponseEntity<SearchResponse> searchInUploadedPdf(
        ...
        SearchResponse response = pdfService.searchInUploaded(fileId, query, caseSensitive, contextChars, useSemantic,pageRequest,pagination);
        return ResponseEntity.status(HttpStatus.OK).body(response);
    }
    ...
    public ResponseEntity<SearchResponse> uploadAndSearch(
        ...
        SearchResponse response = pdfService.uploadAndSearch(file, query, caseSensitive, contextChars, useSemantic, pageRequest,pagination);
        return ResponseEntity.status(HttpStatus.OK).body(response);
    }
}